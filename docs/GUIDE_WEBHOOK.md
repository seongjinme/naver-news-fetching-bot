...
3. 새로 생성된 Webhook의 URL을 복사하여 `Code.gs`의 `globalVariables()`에 위치한 설정값에 붙여넣습니다.<p><img src="../static/images/add_webhook_result.png" width="500" alt="Copy URL of new webhook in Google Chat"></p>
