function listSource() {
  return list = [
    ...
    ["dream.kotra.or.kr/kotranews/index.do","KOTRA해외시장뉴스"  ],
    ["dt.co.kr","디지털타임스"  ],
    ["dtnews24.com","디트뉴스24"  ],
    ["dynews.co.kr","동양일보"  ],
    ...
    ["electimes.com","전기신문"  ],
    ["elle.co.kr","엘르"  ],
    ["en.yna.co.kr/image/index","EPA연합뉴스"  ],
    ...
    ["fish.darakwon.co.kr/main.asp","낚시춘추"  ],
    ["fnnews.com","파이낸셜뉴스"  ],
    ["fntimes.com","한국금융신문"  ],
    ["fomos.kr","포모스"  ],
    ...
    ["jtv.co.kr/2012/?r=home&c=10/70","JTV전주방송"  ],
    ["jumpball.co.kr","점프볼"  ],
    ["junggi.co.kr","중기이코노미"  ],
    ["k-health.com","헬스경향"  ],
    ["kado.net","강원도민일보"  ],
    ...
    ["newdaily.co.kr","뉴데일리"  ],
    ["news.cts.tv","CTS"  ],
    ["news.etomato.com","뉴스토마토"  ],
    ["news.itimes.co.kr","인천일보"  ],
    ...
    ["srn.hcn.co.kr/index.do","HCN 새로넷방송"  ],
    ["srtimes.kr","SR타임스"  ],
    ...
    ["taxtimes.co.kr","세정신문"  ],
    ["tbc.co.kr","TBC대구방송"  ],
    ["tbs.seoul.kr/index/main.do","TBS"  ],
    ...
    ["voanews.com/korean","VOA"  ],
    ["vogue.co.kr","VOGUE"  ],
    ["vop.co.kr","민중의소리"  ],
    ["web.pbc.co.kr","가톨릭평화방송·평화신문"  ],
    ["web.ubc.co.kr/wp","ubc울산방송"  ],
