...
* 원하는 키워드가 포함된 최신 네이버 뉴스 항목을 Google Chat 또는 Slack의 특정 채널에 자동으로 공유합니다.
...
### Screenshot
#### Google Chat 화면
<img src="https://github.com/seongjinme/naver-news-fetching-bot/blob/main/static/images/chat_item_card_v2.1_google.jpg" width="300" alt="Example image (Google Chat)">

#### Slack 화면
<img src="https://github.com/seongjinme/naver-news-fetching-bot/blob/main/static/images/chat_item_card_v2.1_slack.jpg" width="300" alt="Example image (Slack)">
