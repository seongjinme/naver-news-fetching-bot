...
const CONFIG = {
   ...
   *
   * KEYWORDS         : [필수] 모니터링할 네이버 뉴스 검색어를 문자열 배열 형태로 설정합니다.
   ...
   *                    IS_ENABLED가 true여도 url의 값이 빈 값("")으로 설정된 경우 해당 채널로는 뉴스가 전송되지 않습니다.
   *                    모든 서비스의 IS_ENABLED가 false로 설정되거나, 모든 서비스의 url이 빈 값("")으로 설정된다면
   *                    채팅 서비스로의 뉴스 전송 기능은 동작하지 않습니다.
